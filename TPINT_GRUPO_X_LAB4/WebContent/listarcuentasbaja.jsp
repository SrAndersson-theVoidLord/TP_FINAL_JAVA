		...
		<a href="index_admin.jsp" style="color: #fcb045;" class="nav-link">Volver a Inicio</a>
			...
			<div class="container-fluid">
				<div class="jumbotron jumbotron-fluid">
					<div class="container">
						<h1 class="display-3">Listado Cuentas Eliminadas</h1>
					</div>
				</div>
				<%
					if (request.getAttribute("log") != null) {

						JOptionPane.showMessageDialog(null, "Cuenta Recuperada Correctamente");
					}
				%>
				<%
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										Desea recuperar a la cuenta Nro:
									...
									<div class="modal-footer">
										...
										<a class="btn btn-success"
											href="ServletCuentas?cuentarecuperar=<%=cuenta.getNro_Cuenta()%>">
											Confirmar </a>
