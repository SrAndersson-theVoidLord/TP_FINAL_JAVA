...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_content">
			...
			<a href="index_admin.jsp" style="color: #fcb045;" class="nav-link">Volver a Inicio</a>
				<div class="jumbotron jumbotron-fluid">
					<div class="container">
						<h1 class="display-3">Listado Clientes Eliminados</h1>
					</div>
				</div>
				...
				<%
					if (request.getAttribute("log") != null) {
						JOptionPane.showMessageDialog(null, "Usuario Recuperado Correctamente");
					}
				%>
				<%
 ...
 %> <a><button type="button" class="btn btn-success"
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a class="btn btn-success"
											href="ServletUsuario?rec=<%=usert.getDni()%>"> Confirmar
										</a>
			...
			<!-- ./container --> <footer class="py-4 bg-light mt-auto">
			<div class="container-fluid">
